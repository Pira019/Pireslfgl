...
<main id="wp-toolbar" role="main">
			            ...
			            <div class="row">
			                <div class="col-lg-6 col-md-6">
						        <?php if( get_theme_mod('vancura_about_title') != ''){ ?>
						        	...
						        	<img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/border.png');?>" class="border-img" alt="<?php the_title(); ?> post thumbnail image">
						        <?php }?>
			...
			<div class="container">
				<div class="step-head">
					<?php if( get_theme_mod('vancura_steps_title') != ''){ ?>
			        	...
			        	<img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/border.png');?>" class="border-img" alt="<?php esc_attr_e( 'Border Image','vancura' );?>">
			        <?php }?>
	...
	<?php /*--- Counter Section ---*/ ?>
	<?php if( get_theme_mod('vancura_counter_title') != '' || get_theme_mod( 'vancura_counter_subline' )!= '' ){ ?>
		<section id="counter">
			<div class="container">
			...
			<div class="container">
				<div class="team-head">
					<?php if( get_theme_mod('vancura_team_title') != ''){ ?>
			        	<h3><?php echo esc_url(get_theme_mod('vancura_team_title','')); ?></h3>
				...
				<div class="row owl-carousel m-0">
					...
					<?php while( $page_query->have_posts() ) : $page_query->the_post(); ?>
						<div class="testimonials">
							<div class="icon-test">
								<img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/testimonial-icon.png');?>" class="testimonial-img" alt="<?php esc_attr_e( 'Icon Image','vancura' );?>">
							</div>
							<p><?php $excerpt = get_the_excerpt(); echo esc_html( vancura_string_limit_words( $excerpt,20 ) ); ?></p>
					...
					<div class="col-lg-4 col-md-12">
						<div class="clients-head">
							<?php if( get_theme_mod('vancura_clients_title') != ''){ ?>
					        	...
					        	<img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/border.png');?>" class="border-img">
					        <?php }?>
